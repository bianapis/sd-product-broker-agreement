 ...
 */
public class ProductBrokerAgreementBase   {
  ...
  **/
  ...
  /**
   * `status: Registered` iso-link: [click-here](https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_FNqJt8TGEeChad0JzLk7QA_-1317971633) bian-reference: ProductBrokerMasterAgreement(as Agreement).RoleInAgreement.Player(as Party)  
